        ...
        <div className="banner-feature">
         ...
         >
            <div className="banner-feature-wrapper " >
                <a href="#" className="banner-feature-items">
                ...
                <a href="e:" className="banner-feature-items">
                    <span className="banner-feauter-thumb">
        ...
        <div className="main-body-tabbing">
            ...
            <div className="main-tabbing">
                <ul className="nav">
                    ...
                    <a className="nav-link link-secondary active" id="all-tab" data-bs-toggle="tab" data-bs-target="#betsall" href="#"><span>All</span></a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link link-secondary" id="combo-tab01" data-bs-toggle="tab" data-bs-target="#combo01" href="#"><span>Live</span></a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link link-secondary" id="combo-tab02" data-bs-toggle="tab" data-bs-target="#combo02" href="#"><span>Today</span></a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link link-secondary" id="combo-tab03" data-bs-toggle="tab" data-bs-target="#combo03" href="#"><span>Tomorrow</span></a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link link-secondary" id="combo-tab04" data-bs-toggle="tab" data-bs-target="#combo04" href="#"><span>1h</span></a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link link-secondary" id="combo-tab05" data-bs-toggle="tab" data-bs-target="#combo05" href="#"><span>3h</span></a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link link-secondary" id="combo-tab06" data-bs-toggle="tab" data-bs-target="#combo06" href="#"><span>6h</span></a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link link-secondary" id="combo-tab07" data-bs-toggle="tab" data-bs-target="#combo07" href="#"><span>12h</span></a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link link-secondary" id="combo-tab08" data-bs-toggle="tab" data-bs-target="#combo08" href="#"><span>24h</span></a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link link-secondary" id="combo-tab09" data-bs-toggle="tab" data-bs-target="#combo09" href="#"><span>Calender</span></a>
                    </li>
                </ul>
                    ...
                    <div className="tab-pane fade show active" id="betsall" role="tabpanel">
                        ...
                        <div className="progress-slider-items">
                            ...
                            <div className="match-pointing">
                                <a href="#0" className="match-pointing-box">
                        ...
                        <div className="table-wrap mb-10 pb-10">
                            <div className="table-inner">
                                ...
                                <div className="table-body">
                                    ...
                                    <div className="ebasket-right-content">
                                        <a href="#0"><span className="blods">0</span>  S1 GP</a>
                                        <a href="#0">40</a>
                                        <a href="#0"><span className="blods">0</span> 17 30 6</a>
                                    </div>
                                    </div>
                                    <div className="table-body-right">
                                    <a href="#0" className="table-pointing-box">
                        ...
                        <div className="accordion" id="countries">
                            ...
                            <div className="accordion-header" id="countriestab1">
                                ...
                                <div id="countries1" className="accordion-collapse collapse" data-bs-parent="#countries">
                                    ...
                                    <a href="#0" className="left-countries">
